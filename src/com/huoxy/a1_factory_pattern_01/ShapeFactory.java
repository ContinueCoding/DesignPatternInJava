package com.huoxy.a1_factory_pattern_01;
 ...
 * 【附】：
 *     简单工厂：一个工厂类，一个产品抽象类。
 *     工厂方法：多个工厂类，一个产品抽象类 - 非模式，为简单工厂的扩展。
 *     抽象工厂：多个工厂类，多个产品抽象类。
 */
public class ShapeFactory {
    ...
    //TODO 工厂方法可以改为静态方法！
    /**
     * 获取Shape的工厂方法，根据shapeType返回相应的Shape。
     * @param shapeType SHAPE_CIRCLE、SHAPE_RECTANGLE、SHAPE_SQUARE
     * @return shape
     */
    public Shape getShape(String shapeType) {
        if(Utils.isEmpty(shapeType)) {
            return null;
        }
